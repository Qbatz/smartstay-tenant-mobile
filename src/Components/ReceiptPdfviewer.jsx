      ...
      <Text style={[styles.value, { color: "#1E45E1" }]}>{selectedReceiptDetail?.receiptInfo?.paymentMode}</Text>
        ...
        <View style={styles.amountBox}>
          ...
          <View style={styles.amountValueBox}>
            ...
            <Text style={styles.amount}>₹ {selectedReceiptDetail?.receiptInfo?.paidAmount}</Text>
          </View>
  ...
  {receiptname=== "SecurityDeposit" ? (
    ...
    <View style={styles.table}>
      ...
      <View style={styles.row}>
        ...
        <Text style={[styles.cell, { flex: 1.2 }]}>₹{selectedReceiptDetail?.invoiceAmount}</Text>
        <Text style={[styles.cell, { flex: 1.2 }]}>₹{selectedReceiptDetail?.receiptInfo?.paidAmount}</Text>
      </View>
    </View>
  )}
</View>
